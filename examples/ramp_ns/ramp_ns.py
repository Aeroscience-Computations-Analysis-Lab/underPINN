...
def run_ramp_ns(cfg) -> dict:
    ...
    print(f"  Viscosity law: {mu_law};  Network: {net_cls.__name__}  layers={layers}")
    ...
    # Restore RNG key + (possibly RAR-resampled) interior pool for a clean resume.
    ...
    try:
        for ep in range(start_ep, epochs):
            ...
            params, opt_state, total, (pl, il, wl, sl, ul) = step(
                params, opt_state, xy_r[ir], xy_in[iin], xy_w[iw],
