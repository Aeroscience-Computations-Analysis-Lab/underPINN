...
Run directly or via the CLI:
    ...
    python examples/PINNs/pipe_flow_rheology/pipe_flow_rheology.py myconfig.yaml
...
(``examples/PINNs/pipe_flow/pipe_flow.yaml``): x ∈ [-3.5, 3.5], R = 0.5 (D = 1),
...
def run_pipe_flow_rheology(cfg) -> dict:
    ...
    # (examples/PINNs/pipe_flow/pipe_flow.yaml) — only the constitutive law differs.
