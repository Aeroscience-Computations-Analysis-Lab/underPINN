...
Run directly or via the CLI:
    ...
    python examples/PINNs/ramp_ns/ramp_ns.py
    python examples/PINNs/ramp_ns/ramp_ns.py myconfig.yaml
    python -m underPINN run examples/PINNs/ramp_ns/config.yaml
