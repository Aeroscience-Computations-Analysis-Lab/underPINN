...
Run directly or via the CLI:
    ...
    python examples/PINNs/AAA_rheology/AAA_rheology.py myconfig.yaml
    python -m underPINN run examples/PINNs/AAA_rheology/config.yaml
...
(``examples/PINNs/AAA/config.yaml``): x ∈ [-3.5, 3.5], R_vessel = 0.5, R_AAA = 1.0,
...
def run_AAA_rheology(cfg) -> dict:
    ...
    # (examples/PINNs/AAA/config.yaml) — only the constitutive law differs.
