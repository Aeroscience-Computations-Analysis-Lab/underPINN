...
Run directly or via the CLI:
    ...
    python examples/PINNs/LDC/run_ldc.py              # uses config.yaml
    python examples/PINNs/LDC/run_ldc.py myconfig.yaml
    python -m underPINN run examples/PINNs/LDC/config.yaml
