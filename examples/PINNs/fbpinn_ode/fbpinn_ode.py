...
Run directly or via the CLI::
    ...
    python examples/PINNs/fbpinn_ode/fbpinn_ode.py
    python examples/PINNs/fbpinn_ode/fbpinn_ode.py myconfig.yaml
    python -m underPINN run examples/PINNs/fbpinn_ode/config.yaml
"""
