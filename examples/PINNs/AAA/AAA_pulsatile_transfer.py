...
Run directly or via the CLI:
    ...
    python examples/PINNs/AAA/AAA_pulsatile_transfer.py
    python examples/PINNs/AAA/AAA_pulsatile_transfer.py myconfig.yaml
    python -m underPINN run examples/PINNs/AAA/AAA_pulsatile_transfer.yaml
