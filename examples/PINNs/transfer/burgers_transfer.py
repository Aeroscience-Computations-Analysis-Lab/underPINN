...
Run directly or via the CLI:
    ...
    python examples/PINNs/transfer/burgers_transfer.py              # uses burgers_transfer.yaml
    python examples/PINNs/transfer/burgers_transfer.py myconfig.yaml
    python -m underPINN run examples/PINNs/transfer/burgers_transfer.yaml
