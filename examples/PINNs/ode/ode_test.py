...
Run directly or via the CLI:
    ...
    python examples/PINNs/ode/ode_test.py                  # uses config.yaml
    python examples/PINNs/ode/ode_test.py myconfig.yaml    # custom config
    python -m underPINN run examples/PINNs/ode/config.yaml
