...
Run directly or via the CLI:
    ...
    python examples/PINNs/K-Epsilon/turbulence.py              # uses config.yaml
    python examples/PINNs/K-Epsilon/turbulence.py myconfig.yaml
    python -m underPINN run examples/PINNs/K-Epsilon/config.yaml
