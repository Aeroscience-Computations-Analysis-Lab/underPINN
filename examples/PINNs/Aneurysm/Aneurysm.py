...
Run directly or via the CLI:
    ...
    python examples/PINNs/Aneurysm/Aneurysm.py
    python examples/PINNs/Aneurysm/Aneurysm.py myconfig.yaml
    python -m underPINN run examples/PINNs/Aneurysm/config.yaml
