...
Run directly or via the CLI:
    ...
    python examples/heat/forward.py                    # uses heat_forward.yaml
    python examples/heat/forward.py myconfig.yaml      # custom config
    python -m underPINN run examples/heat/heat_forward.yaml
